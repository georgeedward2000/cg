...
contract andyINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "andyINU";
    ...
    address payable private _marketingAddress = payable(0x86C7Da50bF7c39Dab20859c748E180eA100799a3);
    ...
    uint256 public _maxTxAmount = 5e15 * 10**9; //0.5 // 5000000000000000
    uint256 public _maxWalletSize = 15e15 * 10**9; //1.5
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (to != address(this) && to != _marketingAddress) {
                require(amount <= _maxTxAmount, "TOKEN: Max Transaction Limit");
            }

            if (to != uniswapV2Pair && to != _marketingAddress && to != address(this)) {
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair)) {
            ...
            //Set Fee for Sells
            // TAX SELLERS 30% WHO SELL WITHIN 24 HOURS (20% marketing + 10% holders redistribution)
